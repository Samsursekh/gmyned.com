...
import client3 from "../Images/clientsImages/client3.jpg";

export default function ClientsTestimonials() {
  return (
    <section className="pb-12 bg-gray-50 sm:pb-16 lg:pb-20">
      <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div className="flex flex-col items-center">
          <div className="text-center ">
            <h2 className=" text-3xl w-full pt-4 font-bold leading-[1.2] text-[#4831d4] sm:text-4xl md:text-[40px]">
              Our happy clients!
            </h2>
          </div>

          <div className="relative mt-4 md:mt-10 md:order-2">
