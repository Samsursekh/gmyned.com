            ...
            <div className="w-full px-4 sm:w-1/2 lg:w-3/12">
              <div className="mb-10 w-[60%] m-auto items-center text-center">
                ...
                <div className="mb-6 flex justify-evenly">
                  <Link
                    href="/"
                    className="mr-3 flex h-8 w-8 items-center justify-center rounded-full border border-stroke text-dark  hover:text-white dark:border-dark-3 dark:text-white sm:mr-4 lg:mr-3 xl:mr-4"
                  >
                    <svg
                      width="8"
                      height="16"
...
const NavLink = ({ link, label }) => {
  return (
    <li>
      <Link
        href={link}
        className="inline-block text-base leading-loose text-body-color hover:font-bold dark:text-dark-6"
      >
        {label}
      </Link>
    </li>
